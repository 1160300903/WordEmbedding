...
if __name__ == "__main__":
    ...
    trg_vocab = st.VOCAB_DIR + sys.argv[2] if len(sys.argv) > 2 else st.VOCAB_DIR + "F10-W5.1de"

    svd_path = st.RES_DIR + sys.argv[3] if len(sys.argv) > 3 else st.RES_DIR + "F10-W5-T80-L300.en-de"
